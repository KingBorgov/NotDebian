...
module.exports = HandleMsg = async (aruga, message) => {
	...
	// Filter Banned People
        ...
        case 'help':
            ...
            .then(() => ((isGroupMsg) && (isGroupAdmins)) ? aruga.sendText(from, `Para ver los comandos de administrador usa: *${prefix}menuadmin*`) : null)
            break
        case 'menuadmin':
            ...
            if (isOwnerBot) {
                await aruga.joinGroupViaLink(linkgrup)
                      .then(async () => {
                          ...
                          await aruga.sendText(chekgrup.id, `Que Onda, Soy DebianBOT. Para averiguar los comandos de este bot usa ${prefix}menu`)
                      })
            } else {

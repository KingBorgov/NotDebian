...
Debian Es un simple BOT de whatsapp creado sin fines de lucro.

*DebianBOT © Todos los derechos reservados.*`
}
...
exports.textMenu = (pushname) => {
    return `
Menú de DebianBOT! , ${pushname} como puedo ayudarte?
...
-❥ *${prefix}stickergif*
Enviar una imagen gif, con una duración menor a 10 segundos y esperar a termine de crearse tu sticker con movimiento.
...
-❥ *${prefix}images*
Buscar imagenes el google. *EJEMPLO : $images NotDebian*

-❥ *${prefix}sreddit*
Para buscar imágenes en el sub de reddit. *EJEMPLO : $sreddit NotDebian*
...
Estadisticas de DebianBOT en el grupo o chat.

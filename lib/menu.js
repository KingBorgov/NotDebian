...
Jagal Es un simple BOT de whatsapp creado sin fines de lucro.

*Jagal © Todos los derechos reservados.*`
}
...
exports.textMenu = (pushname) => {
    return `
Menú de JagalBOT! , ${pushname} como puedo ayudarte?
...
-❥ *${prefix}images*
Buscar imagenes el google. *EJEMPLO : $images Jagal*

-❥ *${prefix}sreddit*
Para buscar imágenes en el sub de reddit. *EJEMPLO : $sreddit Jagal*
...
Estadisticas de JagalBOT en el grupo o chat.
